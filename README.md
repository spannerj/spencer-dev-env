...
* The first vagrant up after a destroy might have issues due to the number of apps workflow has. If it dies complaining about "cannot allocate memory", just reload and it will likely sort itself out.
